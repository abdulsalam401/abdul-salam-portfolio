...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      {
        name: "Cryptography",
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1DcpyGcR-hSer0Lu4-lWLnj3DokKUrdun5A&s",
      },
      {
        name: "Network Security",
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ85scwTW6AMcfQyEuplXHW8RE25MaWJfLeIw&s",
      },
      {
        name: "Malware Analysis",
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRswzK6_MFpebzs2AieoP-d_S-mvskvUmMnug&s",
      },
      {
        name: "Incident Response",
        image: "https://thumbs.dreamstime.com/b/incident-management-icon-focusing-response-systems-effective-safety-monitoring-incident-management-icon-response-351631439.jpg",
      },
      {
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "TryHackMe",
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxUzzbBWkMwiXRh2d9RJcF0Jy_HDya9OcTZw&s",
      },
      {
        name: "Postman",
...
export const education = [
  {
    id: 0,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThnIqGLyeaUVS5miif0A1Zy4KLBfCB7o-CjA&s", // Generic/Placeholder logo or keep existing if link is valid
    school: "Shaheed Benazir Bhutto University Sheringal (SBBU)",
    date: "Nov 2022 - Present", // Assuming current student based on context "Undergraduate"
    grade: "BS CS",
    desc: "Currently pursuing a Bachelor of Science in Computer Science with a specialized focus on Cybersecurity, Cryptography, and Secure System Design. Coursework includes Network Security, Data Structures, Algorithms, and Database Management.",
    degree: "BS Computer Science (Undergraduate)",
  },
  // Removed High School/College entries to focus on University as per professional norms, or we can keep them if requested. 
  // Prompt says "BS Computer Science (Undergraduate)", didn't explicitly say remove others, but "Replace all template content" implies sticking to new bio.
  // I will keep only the University to keep it clean and relevant to the new "Cybersecurity" persona unless asked otherwise.
];
...
import geminiStudent from "./Gemini_Certified_Student.webp";
...
export const certifications = [
  {
    ...
    desc: "Completed the 9-course Google Cybersecurity Professional Certificate covering threat modeling, network security, Linux, SQL, SIEM tools, IDS, Python automation for cybersecurity, and incident detection & response.",
    img: googleCybersecurity,
    grade: "Professional Certificate",
    category: "Cybersecurity",
    featured: true,
    verifyUrl: "https://coursera.org/verify/professional-cert/7L0FJ4UGRDTQ",
    tags: ["Threat Detection", "SIEM", "IDS", "Linux", "SQL", "Python", "Incident Response"],
  },
  {
    id: 1,
    ...
    category: "Cybersecurity",
    featured: true,
    tags: ["Ethical Hacking", "Vulnerability Scanning", "Reconnaissance", "Exploitation"],
  },
  {
    id: 2,
    ...
    desc: "Earned the Certified Cybersecurity Educator Professional (CCEP) credential from RED TEAM LEADERS, demonstrating expertise in security instruction, threat modeling, and defense frameworks.",
    img: ccep,
    grade: "Professional",
    category: "Cybersecurity",
    featured: true,
    tags: ["Red Teaming", "Cyber Defense", "Security Education"],
  },
  {
    id: 3,
    school: "Cisco Networking Academy",
    ...
    desc: "Earned Student Level credential demonstrating introductory knowledge of cybersecurity, including global implications of cyber threats, vulnerabilities, threat detection, and defense strategies.",
    img: cyberSecurity,
    grade: "Credential",
    category: "Cybersecurity",
    tags: ["Cyber Threats", "Security Fundamentals", "Defense Strategies"],
  },
  {
    id: 4,
    school: "Cisco Networking Academy",
    ...
    desc: "Earned Student Level credential demonstrating knowledge of network types, data transmission, cabling, IP addressing, and transport/application layers.",
    img: networkingBasics,
    grade: "Credential",
    category: "Networking",
    tags: ["TCP/IP", "Subnetting", "Routing & Switching", "Protocols"],
  },
  {
    id: 5,
    school: "Cisco Networking Academy",
    ...
    desc: "Demonstrated fundamental knowledge of programming concepts, Python syntax/semantics, data structures, and standard library modules.",
    img: pythonEss1,
    grade: "Credential",
  ...
  },
  {
    ...
    desc: "Intermediate Python mastery including object-oriented programming (OOP), modules, packages, exceptions, and file processing.",
    img: pythonEss2,
    grade: "Credential",
    category: "Programming",
    tags: ["OOP", "Modules & Packages", "File I/O", "Exception Handling"],
  },
  {
    id: 7,
    school: "Udemy",
    ...
    desc: "Studied ethical hacking methodologies, penetration testing workflows, vulnerability identification, and practical exploit techniques.",
    img: ethicalHackingUdemy,
    grade: "Certificate",
    category: "Cybersecurity",
    tags: ["Penetration Testing", "Hacker Methodology", "Exploitation"],
  },
  {
    id: 8,
    school: "Udemy",
    ...
    desc: "Learned techniques to analyze and detect malicious Android applications using static reverse engineering and dynamic sandbox analysis.",
    img: androidMalware,
    grade: "Certificate",
    category: "Cybersecurity",
    tags: ["Malware Analysis", "Android Security", "Reverse Engineering", "Sandboxing"],
  },
  {
    id: 9,
    school: "Udemy",
    ...
    desc: "Hands-on Python programming with focus on data analysis, manipulation, scripting, and scientific libraries.",
    img: pythonDevUdemy,
    grade: "Certificate",
    category: "Programming",
  ...
  },
  {
    ...
    date: "Nov 2025",
    degree: "Gemini Certified Student",
    desc: "Awarded qualification for demonstrating practical knowledge, competencies, and applied prompt engineering with Google AI and Gemini.",
    img: geminiStudent,
    grade: "Qualification",
    category: "AI & Tools",
    tags: ["Google AI", "Gemini", "Prompt Engineering"],
  },
  {
    id: 11,
    school: "TryHackMe",
    date: "2026",
    degree: "TryHackMe Practical Challenges",
    desc: "Hands-on cybersecurity labs and capture-the-flag (CTF) room completions covering real-world attack and defense scenarios.",
    img: tryHackMe,
    grade: "Certificate",
    category: "Cybersecurity",
    tags: ["CTF", "Hands-on Labs", "Network Attacks", "Privilege Escalation"],
  },
  {
    id: 12,
    ...
    desc: "Completed professional development program focusing on technical communication, cross-functional collaboration, and leadership.",
    img: softSkill,
    grade: "Certificate",
...
export const projects = [
  ...
  {
    id: 2,
    title: "Cryptic Secure Communication System",
    date: "Oct 2025 - Dec 2025",
    description:
      "Developed a Django-based web application implementing AES symmetric encryption in CBC mode for secure text and file encryption and decryption. The system allows users to upload files or input plaintext, validates cryptographic key and IV lengths, and securely processes data using padding and unpadding techniques. Implemented file download functionality for encrypted and decrypted outputs with proper content handling.",
    image: crypticImage,
